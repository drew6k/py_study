...
# TW=[]        #    台湾
# for i in a:
#     if i[1].startswith("北京市"):
#         BJ.insert(0,i)
#     elif i[1].startswith("上海"):
#         SH.insert(0,i)
#     elif i[1].startswith("天津"):
#         TJ.insert(0,i)
#     elif i[1].startswith("重庆"):
#         CQ.insert(0,i)
#     elif i[1].startswith("香港"):
#         XG.insert(0,i)
#     elif i[1].startswith("澳门"):
#         AM.insert(0,i)
#     elif i[1].startswith("内蒙古"):
#         NMG.insert(0,i)
#     elif i[1].startswith("广西"):
#         GX.insert(0,i)
#     elif i[1].startswith("西藏"):
#         XZ.insert(0,i)
#     elif i[1].startswith("宁夏"):
#         NX.insert(0,i)
#     elif i[1].startswith("新疆"):
#         XJ.insert(0,i)
#     elif i[1].startswith("河北"):
#         HB1.insert(0,i)
#     elif i[1].startswith("山西"):
#         SX1.insert(0,i)
#     elif i[1].startswith("辽宁"):
#         LN.insert(0,i)
#     elif i[1].startswith("吉林"):
#         JL.insert(0,i)
#     elif i[1].startswith("黑龙江"):
#         HLJ.insert(0,i)
#     elif i[1].startswith("江苏"):
#         JS.insert(0,i)
#     elif i[1].startswith("浙江"):
#         ZJ.insert(0,i)
#     elif i[1].startswith("安徽"):
#         AH.insert(0,i)
#     elif i[1].startswith("福建"):
#         FJ.insert(0,i)
#     elif i[1].startswith("江西"):
#         JX.insert(0,i)
#     elif i[1].startswith("山东"):
#         SD.insert(0,i)
#     elif i[1].startswith("河南"):
#         HEN.insert(0,i)
#     elif i[1].startswith("湖北"):
#         HB2.insert(0,i)
#     elif i[1].startswith("湖南"):
#         HUN.insert(0,i)
#     elif i[1].startswith("广东"):
#         GD.insert(0,i)
#     elif i[1].startswith("海南"):
#         HAIN.insert(0,i)
#     elif i[1].startswith("四川"):
#         SC.insert(0,i)
#     elif i[1].startswith("贵州"):
#         GZ.insert(0,i)
#     elif i[1].startswith("云南"):
#         YN.insert(0,i)
#     elif i[1].startswith("陕西"):
#         SX2.insert(0,i)
#     elif i[1].startswith("甘肃"):
#         GS.insert(0,i)
#     elif i[1].startswith("青海"):
#         QH.insert(0,i)
#     else:
#         TW.insert(0,i)

# b={"北京市":[BJ],"上海市":[SH],"天津市":[TJ],"重庆市":[CQ],"香港":[XG],"澳门":[AM],"内蒙古":[NMG],"广西":[GX],"西藏":[XZ],"宁夏":[NX],"新疆":[XJ],"河北":[HB1],"山西":[SX1],"辽宁":[LN],"吉林":[JL],"黑龙江":[HLJ],"江苏":[JS],"浙江":[ZJ],"安徽":[AH],"福建":[FJ],"江西":[JX],"山东":[SD],"河南":[HEN],"湖北":[HB2],"湖南":[HUN],"广东":[GD],"海南":[HAIN],"四川":[SC],"贵州":[GZ],"云南":[YN],"陕西":[SX2],"甘肃":[GS],"青海":[QH],"台湾":[TW]}
# # print(b)  #已经实现分类打印但没有成行
# # num = [b[i] for i in b]
# import numpy as np
# # # print(np.array(num))
# for i in b:
